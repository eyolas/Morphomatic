...
local Button =
  Sushi.Clickable:NewSushi("DropButton", 4, "CheckButton", "UIDropDownMenuButtonTemplate", true)
...
function Button:New(parent, info)
  ...
  if parent.SetCall then parent:SetCall("OnResize", function() b:UpdateSize() end) end
...
function Button:GetIcon() return self.Icon:GetAtlas() or self.Icon:GetTexture() end
...
function Button:IsFletched() return self.Arrow:IsShown() end
