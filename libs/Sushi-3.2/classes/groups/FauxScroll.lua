...
local Group = LibStub("Sushi-3.2").Group:NewSushi("FauxScroll", 1, "Frame", nil, true)
...
function Group:First() return self:GetOffset() + 1 end

function Group:Last() return min(self:GetOffset() + self.maxEntries, self.numEntries) end

function Group:GetOffset() return FauxScrollFrame_GetOffset(self.Scroll) end

--[[ Parameters ]]
--

function Group:SetMaxDisplayed(max) self.maxEntries = max end

function Group:GetMaxDisplayed() return self.maxEntries end

function Group:SetEntrySize(height) self.entryHeight = height end

function Group:GetEntrySize() return self.entryHeight end

function Group:SetNumEntries(num) self.numEntries = num end

function Group:NumEntries() return self.numEntries end
