local Header = LibStub("Sushi-3.2").Clickable:NewSushi(
  "ExpandHeader",
  1,
  "Button",
...
function Header:Bind(frame) return setmetatable(frame.Button, self) end
...
function Header:GetChecked() return self.Right:GetAtlas() == "Options_ListExpand_Right_Expanded" end
