...
----------------------------------------------------------------------
L["TITLE"]             = "Morphomatic"
L["DESC"]              = "Use the 'MM' macro or the floating button to trigger a random cosmetic toy from your Favorites."
...
if locale == "frFR" then
  L["TITLE"]             = "Morphomatic"
  L["DESC"]              = "Utilisez la macro 'MM' ou le bouton flottant pour déclencher un jouet cosmétique aléatoire parmi vos Favoris."
