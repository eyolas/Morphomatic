...
local function buildCanvas()
  ...
  local resetBtn = Sushi.Button(s1)
  ...
  local selectAll = Sushi.Button(row)
  ...
  local unselectAll = Sushi.Button(row)
  ...
  local resetSel = Sushi.Button(row)
